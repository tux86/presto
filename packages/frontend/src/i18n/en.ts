export const en = {
  ...
  "missions.dailyRate": "Daily rate (excl. tax)",
  ...
  "reporting.revenue": "Revenue (excl. tax)",
  "reporting.avgDailyRate": "Avg. daily rate (excl. tax): {value}",
  ...
  "reporting.allCompanies": "All",
  "reporting.filterCompany": "Company",
