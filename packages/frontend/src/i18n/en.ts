...
export const en: Record<TranslationKey, string> = {
  ...
  "activity.holidayTitle": "Public holiday",
  "activity.holidayMessage": "{name}. Do you still want to enter this day?",
  "activity.holidayDefault": "This day is a public holiday",
