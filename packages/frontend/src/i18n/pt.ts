...
export const pt: Record<TranslationKey, string> = {
  ...
  "about.releaseNotes": "Notas de vers\u00e3o",
  ...
  "activity.note": "Notas",
  "activity.noteHint": "Incluído na exportação PDF",
  "activity.notePdfPlaceholder": "Notas incluídas no PDF...",
  "activity.privateNote": "Notas privadas",
  "activity.privateNoteHint": "Não incluído no PDF",
  "activity.privateNotePlaceholder": "Notas pessoais...",
  ...
  "profile.passwordRequirements": "Mín 8 caracteres, maiúscula, minúscula, dígito, caráter especial",
  "profile.deleteAccount": "Eliminar conta",
  "profile.deleteAccountWarning":
    "Isto eliminará permanentemente a sua conta e todos os seus dados. Esta ação não pode ser desfeita.",
  "profile.deleteAccountConfirm": "Introduza a sua palavra-passe para confirmar",
  "profile.deleteAccountButton": "Eliminar a minha conta permanentemente",
  "profile.downloadData": "Descarregar os meus dados",
